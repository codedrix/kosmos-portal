	...
	<div class="bg-white rounded-lg border border-gray-200">
		...
		{#if recentWorlds.length === 0}
			<div class="p-8 text-center text-gray-400">
				...
				<p>
					No worlds yet. <a href="/upload" class="text-indigo-600 hover:underline"
						>Upload your first world</a
					>.
				</p>
			</div>
		{:else}
				...
				{#each recentWorlds as world}
					...
					>
						<div class="flex items-center gap-4">
							...
							{:else}
								<div
									class="w-12 h-8 rounded bg-gray-100 border border-gray-200 flex items-center justify-center"
								>
									<svg
